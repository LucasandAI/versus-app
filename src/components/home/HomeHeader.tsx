...
const HomeHeader: React.FC<HomeHeaderProps> = ({
  ...
  // Use our new badge hook instead of useUnreadMessages
  const { badgeCount, clearCount } = useChatBadge();
  ...
  // Listen for chat message received events to update badge
  useEffect(() => {
    const handleMessageReceived = () => {
      console.log("[HomeHeader] Chat message received event detected");
    };
  ...
  const handleChatOpen = () => {
    // When opening the chat drawer, clear the badge count
    clearCount();
    open();
  };
