...
import { isTestMode } from '@/utils/date/matchTiming';
...
const MatchProgressBar: React.FC<MatchProgressBarProps> = ({
  ...
  // Use faster animations in test mode
  const defaultDuration = isTestMode() ? 150 : 300;
  ...
  useEffect(() => {
    ...
    animateProgress();
  }, [homeDistance, awayDistance, duration]);
