...
const ChatDrawerHeader: React.FC<ChatDrawerHeaderProps> = ({
  ...
  return <DrawerHeader className="border-b px-4 py-3 flex items-center sticky top-0 z-50 bg-white">
      <DrawerTitle className="flex-1 text-center">
        {selectedClub ? <div className="flex items-center justify-center gap-2 cursor-pointer hover:text-primary transition-colors" onClick={handleClubClick}>
